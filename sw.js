...
const VERSION = "tiku-v4";
const CORE = [
  "./", "./index.html", "./industry.html", "./quiz.html", "./exam.html", "./wrong.html",
  "./css/style.css", "./js/app.js", "./js/quiz.js", "./js/exam.js", "./js/wrong.js", "./js/stats.js",
...
self.addEventListener("fetch", e => {
  ...
  // 行业题库 JSON：网络优先，失败回退缓存（保证更新及时、离线可用）
  if (url.pathname.includes("/data/") && url.pathname.endsWith(".json") && !url.pathname.endsWith("manifest.json")) {
    e.respondWith(
      fetch(e.request)
        .then(res => {
